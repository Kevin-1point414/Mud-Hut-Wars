...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CreationManager.moneyDisplay.GetComponent<TextMeshProUGUI>().text = "Money Left: 0";
        ...
        RoundManager.timeDisplay.GetComponent<TextMeshProUGUI>().text = "Time Left: 0";
        RoundManager.roundDisplay = GameObject.Find("RoundDisplay");
        RoundManager.roundDisplay.GetComponent<TextMeshProUGUI>().text = "Round: 0";
    ...
    {
        GetComponent<Canvas>().worldCamera = player.GetComponent<Camera>();
        GameObject.Find("RoundManager(Clone)").GetComponent<RoundManager>().UILoaded();
    }
